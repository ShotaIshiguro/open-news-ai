    ...
    <section className="hero-shell mx-auto mb-10 w-full min-h-screen px-20 py-12 relative overflow-hidden">
      ...
      <div className="grid gap-10 px-8 py-12 md:grid-cols-[1.2fr_0.8fr] md:px-12 md:py-14 relative z-10">
        <div>
          ...
          <div
            className={`mt-6 transition-all duration-500 ease-out overflow-hidden bg-mauve-900 rounded-md p-4 ${isTopicAddAreaOpen ? "max-h-40 max-w-[80%] opacity-80" : "max-h-0 max-w-0 opacity-0"}`}
          >
            ...
            <form onSubmit={handleSubmitTopicAdd}>
              <div className="flex justify-between mt-4 items-center">
                ...
                />
                <button className="bg-neutral-100 text-mauve-900 px-4 py-2 rounded-md h-10">
                  Suggest
                </button>
              </div>
            </form>
